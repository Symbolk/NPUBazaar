 ...
 * 
 */
public class BazaarFragment extends Fragment implements
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		...
		case R.id.rb_filelist:
			switchFragmen(getActivity().getString(R.string.square));
			break;
		case R.id.rb_tools:
			switchFragmen(getActivity().getString(R.string.shops));
			break;
		case R.id.rb_transferlist_right:
			switchFragmen(getActivity().getString(R.string.catagory));
			break;
		default:
			break;
		}
